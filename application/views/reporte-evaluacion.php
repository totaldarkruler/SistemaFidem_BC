...
<div id="reporte">
    <div class="hoja">
                    ...
                    <tbody>
                        ...
                        <tr>
                         ...
                         <tr>
                            ...
                            <td>$ <?php echo $proyecto->costo_total; ?></td>
                        </tr>
                         <tr>
        ...
        <div class="seccion">
            <p style="text-align: center;">(Calificación máxima 50 puntos. Calificación Mínima para que continue en el proceso: 40 Puntos)</p>
        </div>
        ...
        <div class="seccion">
            <div>
                <table id="tabla-evaluacion-comentarios">
                    <thead>
                      <tr>
                            <th style="width: 1000px;">Comentarios y Recomendaciones del CEI:</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td style="width: 1000px;"><?php echo $proyecto->observaciones_evaluacion; ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
