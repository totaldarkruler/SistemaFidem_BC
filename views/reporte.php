...
<link href="/css/estilos_impresion2.css" rel="stylesheet" type="text/css">
                        ...
                        <table>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <!-- delete this row <td class="alinear-centro"><?php echo @date("d/m/Y", strtotime($proyecto->fecha_inicio)); ?></td> -->
                                    <?php endif; ?>
                ...
                <div class="seccion">
                    ...
                    <div>
                        ...
                        <div id="firmas">
                            ...
                            <div>
                                <span>por la secretaria de Hacienda del estado</span>
                            </div>
                            ...
                            <div>
                                <span>por la secretaría de educacion del estado</span>
                            </div>

                            <div>
                                <span>por la fiscalia general del estado</span>
                            </div>
